...
public class CustomerController {
    ...
    @Schema(implementation = CustomerDTO.class))}),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Invalid " +
                    "request", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Customers not " +
                    "found", content = @Content)})
    @GetMapping("/active")
    public ResponseEntity<ApiResponse<List<CustomerDTO>>> getCustmers(@Parameter(description = "Active status of the " +
    ...
    @ApiResponses(value = {@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "204", description =
            "Customer deleted successfully", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Invalid ID " +
                    "supplied", content = @Content),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Customer not " +
                    "found", content = @Content)})
    @DeleteMapping("{customerID}")
    public ResponseEntity<ApiResponse<Integer>> deleteCustomer(@Parameter(description = "ID of the customer to be " +
    ...
    public ResponseEntity<ApiResponse<CustomerDTO>> updateCustomer(@Parameter(description = "ID of the customer to be" +
